...
//        performSegue(withIdentifier: "segueToPhotoVC", sender: sender)
    ...
    func prepareCamera() {
        ...
        let availableDevices = AVCaptureDevice.DiscoverySession.init(deviceTypes: array, mediaType: AVMediaType.video, position: AVCaptureDevice.Position.back).devices
